...
pub const ParticalEmitter = struct {
    ...
    pub fn emitPartical(self: *@This(), entities: *EntityStore(Partical)) !void {
    ...
    pub fn update(self: *@This(), entities: *EntityStore(Partical), elapsed_ms: u64) !void {
...
pub fn updatePositionsVerlet(particals: *EntityStore(Partical), dt: f32) void {
...
pub fn updatePositionsVerlet2(particals: *EntityStore(Partical), dt: f32) void {
    for (particals.getObjects()) |*p| {
...
pub fn drawParticals(particals: *EntityStore(Partical)) void {
    for (particals.getObjects()) |*p| {
        rl.drawCircle(
